...
echo "=== canary gap2024 altSig --addGaus 全bin START $(date +%H:%M:%S) ==="
$F $MOD --flag $WP --doFit --altSig --addGaus --fitSample mcNom
$F $MOD --flag $WP --doFit --altSig --addGaus --fitSample data
