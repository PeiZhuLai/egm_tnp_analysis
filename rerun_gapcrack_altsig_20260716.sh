...
echo "=== rerun gap crack altSig bin0,3 (4 gap cfg) + sumUp START $(date +%H:%M:%S) ==="
for c in elminiIso0p1_gap_2024 elminiIso0p1_gap_2025 elminiIso0p15_gap_2024 elminiIso0p15_gap_2025; do
