...
def EffiGraph1D(effDataList, effMCList, sfList ,nameout, xAxis = 'pT', yAxis = 'eta'):
    ...
    def _chooseLegendCoords(effDataList, xAxis, isTargetElectronSF):
        ...
        if 'pT' in xAxis or 'pt' in xAxis:
            ...
            if nkeys == 1:
                ...
                leg_height = min(0.28, 0.034 * nkeys)
                return (0.54, 0.92 - leg_height, 0.94, 0.92)
            else:
    ...
    legStyle = rt.TLegend(0.18, 0.84, 0.39, 0.92) if crowded_eta_legend else rt.TLegend(0.35,0.84,0.73,0.92)
