...
exec /afs/cern.ch/work/p/pelai/HZa/TnP/eos_retry.sh -- \
  python3 tnpEGM_fitter.py etc/config/hza_ele/settings_htoza_elminiIso0p1_nongap_2024.py \
  --flag hza_elminiIso0p1_nongap_2024_sf --altSigBkg --doFit --doPlot --iBin 38
