...
exec /afs/cern.ch/work/p/pelai/HZa/TnP/eos_retry.sh -- \
  python3 tnpEGM_fitter.py etc/config/hza_ele/settings_htoza_sielleg30trigger_nongap_2025.py \
  --flag hza_sielleg30trigger_nongap_2025_sf  --doFit --doPlot --iBin 52
