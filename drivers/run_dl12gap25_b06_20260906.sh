...
exec /afs/cern.ch/work/p/pelai/HZa/TnP/eos_retry.sh -- \
  python3 tnpEGM_fitter.py etc/config/hza_ele/settings_htoza_dielleg12trigger_gap_2025.py \
  --flag hza_dielleg12trigger_gap_2025_sf --altSig --doFit --doPlot --iBin 6
