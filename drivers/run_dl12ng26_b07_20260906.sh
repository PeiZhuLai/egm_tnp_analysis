...
exec /afs/cern.ch/work/p/pelai/HZa/TnP/eos_retry.sh -- \
  python3 tnpEGM_fitter.py etc/config/hza_ele/settings_htoza_dielleg12trigger_nongap_2026.py --flag hza_dielleg12trigger_nongap_2026_sf --altBkg --doFit --doPlot --iBin 7
