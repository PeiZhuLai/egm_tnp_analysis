...
tnpParAltSigBkgFitByBin = {
    ...
    6: params_with_updates(
        ...
        'alphaF[2.4, 1.4, 3.5]',
        'nF[0.6, 0.0, 1.5]',
        # bin6 data RISES toward high mass (866 -> 3411 over 60-120 GeV).
        # The old range [-0.15, -0.005] was entirely negative, so the
        # exponential could only fall and railed flat at the upper edge.
        # Let the upper bound cross zero. bin0 keeps its falling range.
