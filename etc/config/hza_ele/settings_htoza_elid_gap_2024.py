...
tnpParAltSigFitByBin = {
    0: params_with_updates(
        ...
        "meanP[-1.2,-5.0,5.0]",
        "sigmaP[5.5,1.0,12.0]",
        "sigmaP_2[2.0,0.3,10.0]",
        "alphaP[1.8,0.8,4.0]",
        "nP[0.8,0.0,8.0]",
        "sosP[1.5,0.1,8.0]",
        "meanF[-3.0,-6.0,5.0]",
        "sigmaF[8.0,1.0,20.0]",
        "sigmaF_2[2.0,0.3,10.0]",
        "alphaF[1.8,0.8,4.0]",
        "nF[1.0,0.0,8.0]",
        "sosF[3.0,0.2,10.0]",
        "acmsP[95.,25.,130.]",
        "betaP[0.06,0.001,0.18]",
        "gammaP[0.10,0.001,2.0]",
        "acmsF[70.,20.,130.]",
        "betaF[0.05,0.001,0.18]",
    ...
    10: params_with_updates(
        ...
        "meanP[-0.2,-5.0,5.0]",
        "sigmaP[2.5,0.7,8.0]",
        "sigmaP_2[1.5,0.3,6.0]",
        "alphaP[2.0,0.8,4.0]",
        "nP[2.0,-2.0,8.0]",
        "sosP[1.0,0.0,6.0]",
        "meanF[0.5,-5.0,5.0]",
        "sigmaF[4.0,1.0,12.0]",
        "sigmaF_2[1.5,0.3,8.0]",
        "alphaF[1.8,0.8,4.0]",
        "nF[0.6,0.0,6.0]",
        "sosF[1.0,0.0,6.0]",
        "acmsP[90.,25.,130.]",
        "betaP[0.04,0.001,0.15]",
        "gammaP[0.04,0.001,2.0]",
        "acmsF[85.,25.,130.]",
        "betaF[0.04,0.001,0.15]",
        "gammaF[0.04,0.001,2.0]",
    ),
}
