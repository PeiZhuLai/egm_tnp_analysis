...
# flag to be Tested
flags = {
    'hza_elminiIso0p15_nongap_2026_sf': '(el_miniPFRelIso_all < 0.15)',
}
...
# --- Joseph 2026-07-18 per-bin tunes (0p15_nongap_2026) ---
...
tnpParAltSigBkgFitByBin[35] = params_with_updates(
