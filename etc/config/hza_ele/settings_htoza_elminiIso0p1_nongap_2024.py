...
# bin19,20 (central et20-35) altSig failing shoulder 過描述(Joseph 2026-07-18): 收窄 shoulder
# Gaussian(meanGF↑78.5/sigmaGF↑cap3.8 減左側74-78 overshoot) + DSCB core 略寬(sigmaF 1.6)填 valley。
_bin1920_altsig = params_with_updates(tnpParAltSigFit, "meanF[0.0,-3.0,3.0]", "sigmaF[1.8,0.9,3.2]", "sigmaF_2[1.2,0.5,2.5]", "sosF[0.2,0.0,1.0]", "alphaF[2.5,1.6,3.2]", "nF[0.6,0.0,1.2]") + ["meanGF[77.5,75.0,80.0]", "sigmaGF[3.5,2.5,4.5]"]
for _b in (19, 20):
    tnpParAltSigFit_addGausByBin[_b] = _bin1920_altsig
