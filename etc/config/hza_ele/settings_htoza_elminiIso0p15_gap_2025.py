...
# flag to be Tested
flags = {
    'hza_elminiIso0p15_gap_2025_sf': '(el_miniPFRelIso_all < 0.15)',
}
...
tnpParAltSigFitByBin = params_for_bins(
    ...
    (1, 2),
    "sigmaP[3.4,1.0,8.0]",
    "sigmaP_2[2.2,0.5,6.0]",
    "sosP[1.2,0.0,4.5]",
    "alphaP[1.6,0.6,4.5]",
    "nP[0.6,-2.0,10.0]",
    "meanF[0.2,-2.5,2.5]",
    "sigmaF[1.4,0.5,3.2]",
    "sigmaF_2[0.9,0.3,2.5]",
    "sosF[0.25,0.0,1.2]",
    "alphaF[2.0,1.0,4.0]",
    "nF[1.2,0.0,8.0]",
    "acmsP[56.,42.,70.]",
    "betaP[0.018,0.001,0.05]",
    "gammaP[0.03,0.001,0.5]",
    "acmsF[58.,40.,85.]",
    "betaF[0.025,0.001,0.06]",
...
# altSigBkg bin1,2 failing shoulder 過描述(Joseph 2026-07-18): 薄 DSCB 尾(nF↓)逼 addGaus Gaussian
# 乾淨做 shoulder,減肥尾 overshoot(同 altSig 修法)。只動 altSigBkg。
_gap_asb_thintail = ("sigmaF[2.0,1.0,3.5]", "sigmaF_2[1.5,0.6,3.0]", "sosF[0.3,0.0,1.2]", "alphaF[2.5,1.6,3.2]", "nF[0.6,0.0,1.2]", "meanGF[77.0,74.0,80.0]", "sigmaGF[4.0,3.0,6.0]")
for _gb in (1, 2):
    tnpParAltSigBkgFit_addGausByBin[_gb] = params_with_updates(list(tnpParAltSigBkgFit_addGausByBin[_gb]), *_gap_asb_thintail)
