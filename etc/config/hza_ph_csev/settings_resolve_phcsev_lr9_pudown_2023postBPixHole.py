...
flags = {
    ...
    'hza_resolve_phcsev_lr9_pudown_2023postBPixHole_sf': (
        # electron veto
...
#    { 'var' : 'ph_sc_abseta' , 'type': 'float', 'bins': [0.0,1.4442,1.566,2.5] },
   { 'var' : 'ph_et' , 'type': 'float', 'bins': [10,35,80] },
]
...
tnpParNomFitByBin = {
    0: params_with_updates(
        ...
        "sigmaF[1.6,0.5,2.8]",
        "acmsF[45.,25.,65.]",
        "betaF[0.01,0.0005,0.04]",
        "gammaF[0.02,0.001,0.25]",
    ),
...
tnpParAltSigBkgFitByBin = {
    0: params_with_updates(
        ...
        'meanF[-0.2, -2.0, 1.0]',
        'sigmaF[0.8, 0.2, 1.5]',
        'sigmaF_2[0.6, 0.1, 1.5]',
        'sosF[0.08, 0.0, 0.5]',
        'alphaF[2.0, 1.4, 3.0]',
        'nF[0.5, 0.0, 2.0]',
        'alphaF_2[-0.08, -0.3, -0.005]',
    ),
    3: params_with_updates(
        tnpParAltSigBkgFit,
        'meanF[-0.2, -1.5, 1.0]',
