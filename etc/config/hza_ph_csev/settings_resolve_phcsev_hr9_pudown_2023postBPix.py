...
flags = {
    ...
    'hza_resolve_phcsev_hr9_pudown_2023postBPix_sf': (
        # electron veto
...
#############################################################
biningDef = [
   { 'var' : 'event_nPV' , 'type': 'float', 'bins': [10,25,30,100] },
...
_BARREL_FAIL_NOMINAL = (
    "sigmaP[1.4,0.4,5.0]",
    "acmsP[75.,45.,95.]",
    "betaP[0.03,0.001,0.12]",
    "gammaP[0.08,-2.,2.]",
    "peakP[90.0,84.0,94.0]",
    "meanF[-0.2,-1.5,1.0]",
    "sigmaF[1.4,0.4,5.0]",
    "acmsF[45.,20.,70.]",
    "betaF[0.01,0.0005,0.08]",
    "gammaF[0.05,0.001,0.5]",
...
_ENDCAP_FAIL_NOMINAL = (
    ...
    "sigmaF[1.6,0.4,5.0]",
    "acmsF[45.,10.,75.]",
    "betaF[0.006,0.0001,0.04]",
    "gammaF[0.03,0.0005,0.4]",
    "peakF[90.0,84.0,94.0]",
)
tnpParNomFitByBin = {
