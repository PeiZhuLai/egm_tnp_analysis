...
flags = {
    ...
    'hza_resolve_phcsev_lr9_bkg_2023preBPix_sf': (
        # electron veto
...
samplesDef = {
        ...
        'mcNom' : tnpSamples.Run3_2023preBPix_zmmg['TT_DY_MC_2023preBPix'].clone(),
        'tagSel': tnpSamples.Run3_2023preBPix_zmmg['TT_DY_MC_2023preBPix'].clone(),
        'mcAlt': tnpSamples.Run3_2023preBPix_zmmg['TT_DY_MC_2023preBPix'].clone(),
    }
