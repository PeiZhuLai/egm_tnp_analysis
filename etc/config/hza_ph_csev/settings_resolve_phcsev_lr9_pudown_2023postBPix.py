...
flags = {
    ...
    'hza_resolve_phcsev_lr9_pudown_2023postBPix_sf': (
        # electron veto
...
samplesDef = {
        'data'  : tnpSamples.Run3_2023postBPix_zmmg['Data_2023postBPix'].clone(),
        'mcNom' : tnpSamples.Run3_2023postBPix_zmmg['DY_MC_NLO_2023postBPix'].clone(),
        'tagSel': tnpSamples.Run3_2023postBPix_zmmg['DY_MC_NLO_2023postBPix'].clone(),
        'mcAlt': tnpSamples.Run3_2023postBPix_zmmg['DY_MC_NLO_2023postBPix'].clone(),
    }
...
if not samplesDef['tagSel'] is None:
    samplesDef['tagSel'].rename('mcAltSel_DY_MC_NLO_2023postBPix')
...
tnpParNomFit = [
    ...
    "meanF[-0,-8,5]","sigmaF[2,0.2,8]",
    "acmsP[60,45,95]","betaP[0.05,0.01,0.4]","gammaP[0.04,-0.5,2]","peakP[87.0,82.0,90.0]",
    "acmsF[60,35,95]","betaF[0.05,0.01,0.4]","gammaF[0.04,-0.5,2]","peakF[87.0,82.0,90.0]",
    ]
_PEAKY_FAIL_NOMINAL = (
    "sigmaP[1.6,0.2,8]",
    "acmsP[75,45,95]",
    "betaP[0.03,0.001,0.4]",
    "gammaP[0.08,-2,2]",
...
#     "meanP[-0,-8,5]","sigmaP[0.9,0.2,8]",
#     "meanF[-0,-8,5]","sigmaF[2,0.2,8]",
#     "acmsP[60,45,95]","betaP[0.05,0.01,0.4]","gammaP[0.1,-0.5,2]","peakP[87.0,82.0,90.0]",
...
#     "meanF[-0,-8,5]","sigmaF[2,0.2,8]",
#     "acmsP[60,45,95]","betaP[0.05,0.01,0.4]","gammaP[0.1,-0.5,2]","peakP[87.0,82.0,90.0]",
#     "acmsF[60,45,95]","betaF[0.05,0.01,0.4]","gammaF[0.1,-0.5,2]","peakF[87.0,82.0,90.0]",
#     ]
...
tnpParAltSigFit = [
    ...
    "nF[3,0,5]",
    "sosF[1,0.5,5.0]",
    "acmsP[40,35,95]","betaP[0.04,0.005,0.4]","gammaP[0.04,-0.5,1]","peakP[89.0,82.0,90.0]",
    "acmsF[50,40,95]","betaF[0.04,0.01,0.4]","gammaF[0.04,-0.5,1]","peakF[89.0,82.0,90.0]",
    ]
...
#     "acmsF[60,40,95]","betaF[0.04,0.01,0.4]","gammaF[0.1,-0.5,1]","peakF[89.0,82.0,90.0]",
#     ]
