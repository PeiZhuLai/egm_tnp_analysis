...
flags = {
    ...
    'hza_resolve_phcsev_lr9_bkg_2024_sf': (
        # electron veto
...
samplesDef = {
        ...
        'mcNom' : tnpSamples.Run3_2024_zmmg['TT_DY_MC_2024'].clone(),
        'tagSel': tnpSamples.Run3_2024_zmmg['TT_DY_MC_2024'].clone(),
        'mcAlt': tnpSamples.Run3_2024_zmmg['TT_DY_MC_2024'].clone(),
    }
...
if not samplesDef['tagSel'] is None:
    ...
    # samplesDef['tagSel'].set_c
    # ut('tag_Ele_pt > 50 && abs(tag_sc_eta) < 2.17 && ph_mva122XV1 > 0.99 && ph_r9 > 0.99')
...
tnpParNomFit = [
    ...
    "acmsP[60.,35.,85.]","betaP[0.05,0.005,0.10]","gammaP[0.04, 0.005, 2]","peakP[87.0,82.0,90.0]",
    "acmsF[65.,30.,90.]","betaF[0.05,0.005,0.10]","gammaF[0.04, 0.005, 2]","peakF[87.0,82.0,90.0]",
    ]
