...
flags = {
    ...
    'hza_resolve_phcsev_lr9_bkg_2022preEE_sf': (
        # electron veto
...
samplesDef = {
        ...
        'mcNom' : tnpSamples.Run3_2022preEE_zmmg['TT_DY_MC_2022preEE'].clone(),
        'tagSel': tnpSamples.Run3_2022preEE_zmmg['TT_DY_MC_2022preEE'].clone(),
        'mcAlt': tnpSamples.Run3_2022preEE_zmmg['TT_DY_MC_2022preEE'].clone(),
    }
...
#   'sosF[0.12, 0.0, 1.0]',
#   'alphaP[2.0, 1.4, 3.5]', 'nP[0.4, 0.0, 1.5]',
#   'alphaF[2.0, 1.4, 3.6]', 'nF[0.4, 0.0, 1.5]',
#   'alphaP_2[-0.012, -1, 0]',
#   'alphaF_2[-0.014, -1, 0.05]',
# ]
