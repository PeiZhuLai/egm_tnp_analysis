...
flags = {
    ...
    'hza_resolve_phcsev_lr9_bkg_2023postBPix_sf': (
        # electron veto
...
samplesDef = {
        ...
        'mcNom' : tnpSamples.Run3_2023postBPix_zmmg['TT_DY_MC_2023postBPix'].clone(),
        'tagSel': tnpSamples.Run3_2023postBPix_zmmg['TT_DY_MC_2023postBPix'].clone(),
        'mcAlt': tnpSamples.Run3_2023postBPix_zmmg['TT_DY_MC_2023postBPix'].clone(),
    }
