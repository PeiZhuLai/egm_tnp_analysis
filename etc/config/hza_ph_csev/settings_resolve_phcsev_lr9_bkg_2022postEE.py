...
flags = {
    ...
    'hza_resolve_phcsev_lr9_bkg_2022postEE_sf': (
        # electron veto
...
samplesDef = {
        ...
        'mcNom' : tnpSamples.Run3_2022postEE_zmmg['TT_DY_MC_2022postEE'].clone(),
        'tagSel': tnpSamples.Run3_2022postEE_zmmg['TT_DY_MC_2022postEE'].clone(),
        'mcAlt': tnpSamples.Run3_2022postEE_zmmg['TT_DY_MC_2022postEE'].clone(),
    }
