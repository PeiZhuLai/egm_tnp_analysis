...
flags = {
    ...
    'hza_resolve_phid_lowpt_2024_sf': (
        # pT + acceptance
...
tnpParNomFit = [
    ...
    "acmsP[55.,35.,80.]","betaP[0.04,0.005,0.10]","gammaP[0.04, 0.005, 2]","peakP[87.0,82.0,90.0]",
    "acmsF[65.,30.,90.]","betaF[0.04,0.005,0.10]","gammaF[0.04, 0.005, 2]","peakF[87.0,82.0,90.0]",
    ]
tnpParNomFitByBin = {
...
tnpParAltSigFit = [
    ...
    "nF[3,0,5]",
    "sosF[1,0.5,5.0]",
    "acmsP[42.,30.,60.]","betaP[0.04,0.002,0.08]","gammaP[0.04, 0.005, 1.5]","peakP[89.0,82.0,90.0]",
    "acmsF[55.,30.,85.]","betaF[0.04,0.002,0.08]","gammaF[0.04, 0.005, 1.5]","peakF[89.0,82.0,90.0]",
    ]
tnpParAltSigFitByBin = {
    3: params_with_updates(
        ...
        "meanP[-0.2,-4.0,4.0]",
        "sigmaP[2.6,0.8,4.0]",
        "sigmaP_2[0.6,0.3,2.0]",
        "alphaP[1.8,1.0,3.2]",
        "nP[0.8,0.0,5.0]",
        "sosP[0.5,0.0,2.0]",
        "acmsP[42.,25.,60.]",
        "betaP[0.03,0.001,0.06]",
        "gammaP[0.03,0.001,0.50]",
        "meanF[-1.2,-5.0,5.0]",
        "sigmaF[4.0,1.0,6.5]",
        "sigmaF_2[0.8,0.3,3.0]",
        "alphaF[1.6,1.0,3.5]",
        "nF[0.5,0.0,5.0]",
        "sosF[1.2,0.0,4.0]",
        "acmsF[50.,25.,85.]",
    ...
    4: params_with_updates(
        ...
        "meanF[0.5,-5.0,5.0]",
        "sigmaF[3.8,0.8,6.0]",
        "sigmaF_2[0.8,0.2,3.0]",
        "alphaF[1.5,1.0,3.5]",
        "nF[0.3,0.0,5.0]",
        "sosF[0.3,0.0,3.0]",
        "acmsF[45.,25.,80.]",
        "betaF[0.02,0.001,0.06]",
        "gammaF[0.03,0.001,0.8]",
    ),
}
...
tnpParAltSigBkgFitByBin = {
    1: params_with_updates(
        ...
        'meanF[-0.5, -5.0, 5.0]',
        'sigmaF[0.8, 0.1, 3.0]',
        'sigmaF_2[0.8, 0.1, 4.0]',
        'sosF[0.20, 0.0, 1.5]',
        'alphaF[2.2, 1.0, 4.0]',
        'nF[0.5, 0.0, 2.5]',
        'alphaF_2[-0.05, -1, 0.05]',
    ),
