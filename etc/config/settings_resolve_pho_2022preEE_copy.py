...
flags = {
    ...
    'passingCustomCutBased': (
        # pT + acceptance
        '(ph_et > 10) && ((abs(ph_sc_eta) < 1.4442) || (abs(ph_sc_eta) > 1.566 && abs(ph_sc_eta) < 2.5))'
        ' && ('
        # ================= EB block =================
        '  (abs(ph_sc_eta) < 1.4442'
        '   && (ph_hoe_PUcorr < 0.0417588)'
        '   && (ph_pfRelIso03_chg_quadratic < 0.316306)'
        '   && (('
        '         (abs(ph_sc_eta) > 0.0 && abs(ph_sc_eta) < 1.0)'
        '         && (ph_hcalPFClusterIso - event_rho*0.17005 - (event_rho*event_rho)*(-0.000835)'
        '             < (0.39057 + 0.0100547*ph_et + 5.78332e-05*ph_et*ph_et))'
        '       ) || ('
        '         (abs(ph_sc_eta) > 1.0 && abs(ph_sc_eta) < 1.4442)'
        '         && (ph_hcalPFClusterIso - event_rho*0.208571 - (event_rho*event_rho)*(-0.000905)'
        '             < (0.39057 + 0.0100547*ph_et + 5.78332e-05*ph_et*ph_et))'
        '       ))'
        '  )'
        '  ||'
        ...
        '   && (ph_hoe_PUcorr < 0.00254267)'
        '   && (ph_pfRelIso03_chg_quadratic < 0.292664)'
        '   && (('
        '         (abs(ph_sc_eta) > 1.566 && abs(ph_sc_eta) < 2.0)'
        '         && (ph_hcalPFClusterIso - event_rho*0.246494 - (event_rho*event_rho)*(-0.000722)'
        '             < (0.0292617 + 0.0116989*ph_et + 7.47603e-05*ph_et*ph_et))'
        '       ) || ('
        '         (abs(ph_sc_eta) > 2.0 && abs(ph_sc_eta) < 2.2)'
        '         && (ph_hcalPFClusterIso - event_rho*0.306529 - (event_rho*event_rho)*(-0.000608)'
        '             < (0.0292617 + 0.0116989*ph_et + 7.47603e-05*ph_et*ph_et))'
        '       ) || ('
        '         (abs(ph_sc_eta) > 2.2 && abs(ph_sc_eta) < 2.3)'
        '         && (ph_hcalPFClusterIso - event_rho*0.322673 - (event_rho*event_rho)*(-0.000750)'
        '             < (0.0292617 + 0.0116989*ph_et + 7.47603e-05*ph_et*ph_et))'
        '       ) || ('
        '         (abs(ph_sc_eta) > 2.3 && abs(ph_sc_eta) < 2.4)'
        '         && (ph_hcalPFClusterIso - event_rho*0.315793 - (event_rho*event_rho)*(-0.000795)'
        '             < (0.0292617 + 0.0116989*ph_et + 7.47603e-05*ph_et*ph_et))'
        '       ) || ('
        '         (abs(ph_sc_eta) > 2.4 && abs(ph_sc_eta) < 2.5)'
        '         && (ph_hcalPFClusterIso - event_rho*0.36531 - (event_rho*event_rho)*(-0.000439)'
        '             < (0.0292617 + 0.0116989*ph_et + 7.47603e-05*ph_et*ph_et))'
        '       ))'
        '  )'
        ' )'
...
samplesDef = {
        ...
        'mcNom' : tnpSamples.Run3_2022preEE['DY_MC_NLO'].clone(),
        'tagSel': tnpSamples.Run3_2022preEE['DY_MC_NLO'].clone(),
        'mcAlt': None,
    }
...
puFile = '/eos/cms/store/group/phys_egamma/ec/nkasarag/EGM_comm/TnP_samples/2022/sim/DY_NLO/puTree/mcRun3_130X_2022_realistic_pho.pu.puTree.root'
...
biningDef = [
   ...
   { 'var' : 'ph_et' , 'type': 'float', 'bins': [10,20,35,50,100,200,500] },
]
