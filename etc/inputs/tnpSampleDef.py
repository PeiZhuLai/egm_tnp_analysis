...
Run3_2022preEE_zmmg = {
        ...
        'Data_2022preEE'         : tnpSample('Data_2022preEE',         eoszmmg + '/Data/2022preEE.root', lumi = 7.98),
        }
Run3_2022postEE_zmmg = {
        ...
        'Data_2022postEE'        : tnpSample('Data_2022postEE',        eoszmmg + '/Data/2022postEE.root', lumi = 26.67),
        }
Run3_2023preBPix_zmmg = {
        ...
        'Data_2023preBPix'       : tnpSample('Data_2023preBPix',       eoszmmg + '/Data/2023preBPix.root', lumi = 108.95),
        }
Run3_2023postBPix_zmmg = {
        ...
        'Data_2023postBPix'      : tnpSample('Data_2023postBPix',      eoszmmg + '/Data/2023postBPix.root', lumi = 108.95),
        }
Run3_2024_zmmg = {
        ...
        'Data_2024'              : tnpSample('Data_2024',              eoszmmg + '/Data/2024.root', lumi = 108.95),
        }
#--------------------------------------------------------------------------------
