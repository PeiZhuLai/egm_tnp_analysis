...
MOD=egm_tnp_analysis.etc.config.hza_ele.settings_htoza_elminiIso0p1_gap_2024
WP=hza_elminiIso0p1_gap_2024_sf
echo "=== refit 0p1_gap_2024 nom 1,2 START $(date +%H:%M:%S) ==="
