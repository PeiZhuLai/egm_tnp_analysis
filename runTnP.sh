...
# -------- Low pT --------
# sh $baseDir/run.sh egm_tnp_analysis.etc.config.settings_resolve_pho_lowpt_2022preEE hza_resolve_phid_lowpt_2022preEE_sf &
# sh $baseDir/run.sh egm_tnp_analysis.etc.config.settings_resolve_pho_lowpt_2022postEE hza_resolve_phid_lowpt_2022postEE_sf &
# sh $baseDir/run.sh egm_tnp_analysis.etc.config.settings_resolve_pho_lowpt_2023preBPix hza_resolve_phid_lowpt_2023preBPix_sf &
sh $baseDir/run.sh egm_tnp_analysis.etc.config.settings_resolve_pho_lowpt_2023postBPix hza_resolve_phid_lowpt_2023postBPix_sf &
